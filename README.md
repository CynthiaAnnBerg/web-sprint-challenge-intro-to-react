...
React JS is a user interface component library, NOT a framework but only a library that renders UI, unopionated managing data. It solves development of large applications that have temporal data changes. 

1. Describe component state.
Component state takes in input data, a component can maintain internal state data (accessed vis this state).

1. Describe props.
Props stands for properties and is being used for passing data from one component to another (one way from parent to child).

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
Side effects are anthing that affects something outside the cope of the function being executed. You sync effects with useEffect, ehenever props change, you set the state inside useEffect. 
